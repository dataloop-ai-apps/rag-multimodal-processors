"""
Excel (XLS/XLSX) processor app.

Excel processor that uses XLSExtractor and ExtractedData throughout.
"""
...
class XLSProcessor(dl.BaseServiceRunner):
    """Excel Processor for extracting text, tables, images, and creating chunks."""

    def __init__(self):
        """Initialize XLS processor."""
